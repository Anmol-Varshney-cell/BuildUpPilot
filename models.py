...
class User(UserMixin, db.Model):
    ...
    # Company ID verification fields for recruiters
    company_id = db.Column(db.String(100))
    company_id_image_path = db.Column(db.String(200))
    company_id_status = db.Column(db.String(20), default='pending_verification')
    company_id_verified_at = db.Column(db.DateTime)
    company_id_verified_by = db.Column(db.Integer, db.ForeignKey('users.id'))
    company_name = db.Column(db.String(120))
    recruiter_request_email = db.Column(db.String(120))
    recruiter_request_otp = db.Column(db.String(6))
    recruiter_request_otp_expires = db.Column(db.DateTime)
    recruiter_request_decline_count = db.Column(db.Integer, default=0)
    recruiter_request_last_submitted_at = db.Column(db.DateTime)
    recruiter_request_last_notification = db.Column(db.Text)
