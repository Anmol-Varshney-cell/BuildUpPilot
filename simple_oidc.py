...
OIDC_CONFIG = {
    ...
    'authorization_endpoint': 'http://localhost:5002/oauth/authorize',
    'token_endpoint': 'http://localhost:5002/oauth/token',
    'userinfo_endpoint': 'http://localhost:5002/oauth/userinfo'
}
